...
class VideoSource:
    ...
    def release(self) -> None:
        """
        Освобождает ресурс видеоисточника.
        """
    ...
    def get_width(self) -> int:
        """
        Возвращает ширину кадров видео.
        """
        if not self.is_opened or self.cap is None:
            raise RuntimeError("Видеоисточник не открыт")
    ...
    def get_height(self) -> int:
        """
        Возвращает высоту кадров видео.
        """
        if not self.is_opened or self.cap is None:
            raise RuntimeError("Видеоисточник не открыт")
    ...
    def get_frame_count(self) -> int:
        """
        Возвращает общее число кадров в видео.
        """
        if not self.is_opened or self.cap is None:
            raise RuntimeError("Видеоисточник не открыт")
    ...
    def get_source_info(self) -> dict:
        """
        Возвращает краткую информацию об источнике.
        """
        return {
